...
export default function Dashboard() {
  ...
  return <main className="public-profile-page dashboard-home page-transition">
    ...
    <WeightProgress userId={user?.id} unit={preferredUnit} />

    <section className="public-profile-section"><ExerciseDisplay workouts={recentWorkouts} loading={workoutsLoading} error={workoutsError} authorProfile={profile} showAuthor={false} exercisePreviewCount={3} /></section>
